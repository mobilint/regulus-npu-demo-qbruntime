...
mobilint::post_lcd::YOLOv8PosePostProcessor::YOLOv8PosePostProcessor()
    : YOLOv8PostProcessor() {
...
*/
void mobilint::post_lcd::YOLOv8PosePostProcessor::decode_extra(
...
void mobilint::post_lcd::YOLOv8PosePostProcessor::run_postprocess(
...
*/
void mobilint::post_lcd::YOLOv8PosePostProcessor::plot_keypoints(
...
*/
void mobilint::post_lcd::YOLOv8PosePostProcessor::plot_extras(
    cv::Mat& im, std::vector<std::vector<float>>& extras) {
    plot_keypoints(im, extras);
}

void mobilint::post_lcd::YOLOv8PosePostProcessor::worker() {
