...
mobilint::post_lcd::YOLOv8SegPostProcessor::YOLOv8SegPostProcessor()
    : YOLOv8PostProcessor() {
...
*/
void mobilint::post_lcd::YOLOv8SegPostProcessor::decode_extra(
...
cv::Mat& mobilint::post_lcd::YOLOv8SegPostProcessor::get_label_mask() {
    return label_masks;
}

cv::Mat& mobilint::post_lcd::YOLOv8SegPostProcessor::get_final_mask() {
    return final_masks;
}

void mobilint::post_lcd::YOLOv8SegPostProcessor::run_postprocess(
    ...
    std::vector<int> det_idx = {1, 4, 6};
    std::vector<int> seg_idx = {0, 3, 5};

    for (int i = 0; i < m_nl; i++) {
        decode_conf_thres(npu_outs[det_idx[i]], m_grids[i], m_strides[i], pred_boxes,
                          pred_conf, pred_label, pred_scores, npu_outs[seg_idx[i]],
                          pred_extra);
    }
...
mobilint::post_lcd::YOLOv8SegPostProcessor::downsample_boxes(
...
/*
        Compute masks
*/
void mobilint::post_lcd::YOLOv8SegPostProcessor::process_mask(
...
/*
        Plot masks on image
*/
void mobilint::post_lcd::YOLOv8SegPostProcessor::plot_masks(
...
void mobilint::post_lcd::YOLOv8SegPostProcessor::worker() {
