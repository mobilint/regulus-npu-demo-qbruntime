...
mobilint::post_hdmi::YOLOv8PostProcessor::YOLOv8PostProcessor() {
    ...
    ticket = 0;
    destroyed = false;
    mThread = std::thread(&mobilint::post_hdmi::YOLOv8PostProcessor::worker, this);
}

mobilint::post_hdmi::YOLOv8PostProcessor::YOLOv8PostProcessor(int nc, int imh, int imw,
                                                              float conf_thres,
                                                              float iou_thres,
                                                              bool verbose) {
...
*/
std::vector<int> mobilint::post_hdmi::YOLOv8PostProcessor::generate_strides(int nl) {
...
*/
std::vector<std::vector<int>> mobilint::post_hdmi::YOLOv8PostProcessor::generate_grids(
...
int mobilint::post_hdmi::YOLOv8PostProcessor::get_nl() const { return m_nl; }

int mobilint::post_hdmi::YOLOv8PostProcessor::get_nc() const { return m_nc; }

/*
        Return the type of Post Processing
*/
mobilint::post_hdmi::PostType mobilint::post_hdmi::YOLOv8PostProcessor::getType() const {
    return mType;
}
...
*/
float mobilint::post_hdmi::YOLOv8PostProcessor::sigmoid(float num) {
...
*/
float mobilint::post_hdmi::YOLOv8PostProcessor::inverse_sigmoid(float num) {
    return -log(1 / num - 1);
}
...
*/
std::vector<float> mobilint::post_hdmi::YOLOv8PostProcessor::softmax(
...
*/
float mobilint::post_hdmi::YOLOv8PostProcessor::area(float xmin, float ymin, float xmax,
                                                     float ymax) {
...
*/
float mobilint::post_hdmi::YOLOv8PostProcessor::get_iou(
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::xywh2xyxy(
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::decode_boxes(
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::decode_extra(
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::decode_conf_thres(
...
/*
        Apply NMS
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::nms(
...
*/
double mobilint::post_hdmi::YOLOv8PostProcessor::set_timer() {
...
mobilint::post_hdmi::YOLOv8PostProcessor::get_result_box() {
    return final_boxes;
}

std::vector<float>& mobilint::post_hdmi::YOLOv8PostProcessor::get_result_score() {
    return final_scores;
}

std::vector<int>& mobilint::post_hdmi::YOLOv8PostProcessor::get_result_label() {
    return final_labels;
}

std::vector<std::vector<float>>&
mobilint::post_hdmi::YOLOv8PostProcessor::get_result_extra() {
    return final_extra;
}

void mobilint::post_hdmi::YOLOv8PostProcessor::run_postprocess(
    const std::vector<std::vector<float>>& npu_outs) {
    double start = set_timer();

    if (npu_outs.size() != 2 * m_nl)
        throw std::invalid_argument(
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::compute_ratio_pads(cv::Mat im,
                                                                  float& ratio,
                                                                  float& xpad,
                                                                  float& ypad) {
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::plot_boxes(
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::plot_extras(
...
*/
void mobilint::post_hdmi::YOLOv8PostProcessor::print(std::string msg) {
#ifdef DEBUG
...
void mobilint::post_hdmi::YOLOv8PostProcessor::compute_ratio(int srcHeight, int srcWidth,
                                                             float& h_ratio,
                                                             float& w_ratio) {
...
void mobilint::post_hdmi::YOLOv8PostProcessor::compute_ratio_pads(int srcHeight,
                                                                  int srcWidth,
...
void mobilint::post_hdmi::YOLOv8PostProcessor::rescaleImg(
...
void mobilint::post_hdmi::YOLOv8PostProcessor::rescaleImgWithPadding(
...
void mobilint::post_hdmi::YOLOv8PostProcessor::rescaleImgWithPaddingV2(
    std::vector<std::array<float, 4>>& rescaled_boxes, int srcHeight, int srcWidth) {
    float gain;
    int xpad, ypad;
...
void mobilint::post_hdmi::YOLOv8PostProcessor::worker() {
...
uint64_t mobilint::post_hdmi::YOLOv8PostProcessor::enqueue(
...
void mobilint::post_hdmi::YOLOv8PostProcessor::receive(uint64_t receipt_no) {
    // auto thres_id = std::hash<std::thread::id>{}(std::this_thread::get_id());
